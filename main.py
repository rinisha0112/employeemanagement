...
app.config['MYSQL_PASSWORD'] = 'wh@tthehell!'
        ...
        if searchType == "empId":
            ...
            try:
                ...
                if len(data) == 0:
                    ...
                    return render_template('searchemployee.html', length = length , result=result)
                    ...
                    return render_template('searchemployee.html', data=data, length = length , result=result)
            ...
            try:
                ...
                cur = mysql.connection.cursor()
                cur.execute('SELECT * FROM `employeetable` WHERE LOWER(`ename`)=%s', (emp_name.lower(),))
                data = cur.fetchall()
                ...
                if len(data) == 0:
                    ...
                    return render_template('searchemployee.html', length=length, data=data, result=result)
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            try:
                cur.execute('select * from employeetable')
                data = cur.fetchall()
                return  render_template('allemployees.html' , data=data,update= result)
            except Exception as e:
                print(e)
